...
exports.getTiendaPlayListContract = void 0;
const dotenv_1 = __importDefault(require("dotenv"));
const ethers_1 = require("ethers");
const Messenger__factory_1 = require("../../../blockchain/typechain/factories/Messenger__factory");
const urls_1 = require("./urls");
dotenv_1.default.config();
const getTiendaPlayListContract = (url = urls_1.BlockchainUrlsEnum.POLYGON_MUMBAI) => {
...
exports.getTiendaPlayListContract = getTiendaPlayListContract;
